...
def main() -> None:
    ...
    print("=" * 60)
    print("  QUANTUM DIGITAL SIGNATURE (QDS) THREAT DETECTION SOC")
    print(f"  >>> Desktop SOC Dashboard:  http://127.0.0.1:{args.port}/")
    print(f"  >>> Ultra-Minimal Mobile UI: http://127.0.0.1:{args.port}/minimal")
    print(f"  >>> Interactive API Docs:   http://127.0.0.1:{args.port}/docs")
    print("=" * 60)
